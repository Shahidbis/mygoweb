...
func GetProducts() Products {
	result := Products{
		Title: "Lemonade Stand Society - Products",
		Active: "shop",
	}
	...
	mangoseteenJuice := MakeMangoseteenJuiceProduct()
...
func MakeLemonJuiceProduct() Product {
	result := Product{
		Name: "Lemon Juice",
		DescriptionShort: "Made from fresh, organic California lemonss.",
		DescriptionLong: `Made from premium, organic Meyer lemons. These fruit are left on the tree until they reach the peak of ripeness and then juiced within 8 hours of being picked.
			<br/>
			Lemonade made from our premium juice is sure to make your stand the most popular in the neighborhoodd.`,
		PricePerLiter: 1.19,
...
func MakeMangoseteenJuiceProduct() Product {
	result := Product{
